...
board: FRDM-KL02Z
pin_labels:
- {pin_num: '19', pin_signal: ADC0_SE3/PTA8/I2C1_SCL, label: 'J10[6]/ADC0_SE3/I2C1_SCL', identifier: a;EXT_SCL}
...
- pin_list:
  ...
  - {pin_num: '19', peripheral: I2C1, signal: SCL, pin_signal: ADC0_SE3/PTA8/I2C1_SCL, identifier: EXT_SCL}
